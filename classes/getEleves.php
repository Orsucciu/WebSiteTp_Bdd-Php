...
for($i = 0; $i < sizeof($row); $i++){
    $body .= "<tr><td>".$row[$i]['NomEleve']."</td><td>".$row[$i]['PrenomEleve']."</td><td><button id=".$row[$i]['NumEleve']." onclick='supprimerEleve(this.id);'>SUPPRIMER</button></td><td id=".$row[$i]['NumEleve']."><button onclick='editerEleve();'>EDITER</button></td></tr>";
}
